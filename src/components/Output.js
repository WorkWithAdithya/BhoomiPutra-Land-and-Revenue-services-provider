...
function Output() {
  ...
  return (
    <div className="p-6 flex flex-col mt-20 items-center">
      <h1 className="text-4xl  font-sans font-bold mb-4 transition-all duration-300 hover:text-blue-500 cursor-pointer">
        Payment Confirmed
      </h1>
      <div className="border p-4 rounded-lg text-center transition-shadow duration-300 hover:shadow-lg">
        <h2 className="text-xl  font-sans font-semibold">{service.name}</h2>
